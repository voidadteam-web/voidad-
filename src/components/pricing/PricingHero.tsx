...
export function PricingHero({ title, line1, line2, line3 }: PricingHeroProps) {
  return (
    <section className="relative min-h-[420px] overflow-hidden pb-8 pt-6 sm:min-h-[520px] sm:pb-12 sm:pt-10">
      <HeroWorldMapBackdrop />

      <div className="relative z-10 max-w-xl lg:max-w-lg">
        <h1 className="void-display text-4xl font-bold text-white sm:text-5xl">{title}</h1>
        <p className="void-display mt-5 text-xs leading-relaxed tracking-[0.18em] text-void-text-mint sm:text-sm">
          {line1}
          <br />
          {line2}
          <br />
